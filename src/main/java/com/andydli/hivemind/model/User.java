...
public class User {
    ...
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) // ensures passwordHash is not serialized in responses
    @Getter(AccessLevel.NONE) // prevents getter generation for passwordHash
